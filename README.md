...
4. **Attenzione:** non selezionare il file `.zip`, ma apri la cartella estratta fino ad arrivare alla sottocartella `webex_assistant` (quella che contiene `manifest.json`).
